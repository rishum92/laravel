                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane active" id="tab_1_1">
                                                                    ...
                                                                    <form role="form" action="{{ url('addfriend/'.$sid)}}" method="post">
                                                                    {!!csrf_field()!!}
                                                                    <div class="form-group">
                                                                        <label class="control-label">Full Name</label>
                                                                        <input type="text" placeholder="" class="form-control" value = "{{ $user->full_name }}"/> </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Email</label>
                                                                        <input type="text" placeholder="" class="form-control" value = "{{ $user->email }}" /> </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Username</label>
                                                                        <input type="text" placeholder="" class="form-control"  value = "{{ $user->username }}"/> </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Country</label>
                                                                        <input type="text" placeholder="" class="form-control" value = "{{ $user->country }}" /> </div>

                                                                        <input type="hidden" name="receiverid" value="{{ $user->id }}" >  @endforeach
                                                                        ...
                                                                        @foreach($status as $statuss)
                                                                         ...
                                                                         <!--  <?php //echo"<pre>";print_r($statuss);die;?> -->
                                                                         @if($statuss->status == 0) 

                                                                         <button type="submit" class="btn green">Request Sent </button>  
                                                                         @elseif($statuss->status == 1)

                                                                         <button type="submit" class="btn green">Your Friend</button> 
                                                                         @elseif($statuss->status == 2)                              
                                                                          <button type="submit" class="btn green">Add Friend </button> 
