                                    ...
                                    <div class="col-md-9">
                                        <div class="inbox-body">
                                            <div class="inbox-header">
                                               ...
                                               <form method = "POST" action = "{{ url ('trashdeletemail') }}">
                                                   {!! csrf_field()!!}
                                       ...
                                       <ul class="dropdown-menu pull-right">
                                             ...
                                             <tbody>
                                                <!--Sent Delete Mail-->
                                                 @foreach($senttrashdata as $trash)
                                                    @if($trash->sent_deleted == 1)

                                                        <tr class="unread" data-messageid="1">
                                                             <td> <input type="checkbox" name = "check[]" value= "{{$trash->m_id}}" ></td>
                                                            <td class="inbox-small-cells">
                                                                <i class="fa fa-star"></i>
                                                            </td>
                                                            <td class="view-message hidden-xs">{{$trash->subject}}</td>
                                                            <td class="view-message "> {{$trash->message}}</td>
                                                        </tr>
                                                    
                                                     @endif
                                                @endforeach
                                                <!-- End Sent Delete Mail-->
