<form class="inbox-compose form-horizontal" id="fileupload" action="{{ url('sendmail')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="inbox-compose-btn">
        ...
        <button type="submit" name="close" value="close" class="btn default">Close</button>
    </div>
</form>