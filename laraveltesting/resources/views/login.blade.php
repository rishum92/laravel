...
<html lang="en">
    ...
    @include('flash_message')
        ...
        <div class="logo">
            <a href="index.html">
                <img src="../assets/images/logo-big.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('myprofile') }}" method="post">
            ...
            <form class="forget-form" action="{{ url('forgetpassword') }}" method="post">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token();?>">
          ...
          <!-- END FORGOT PASSWORD FORM -->
            ...
            <form class="register-form" action="{{ url('userregistration') }}" method="post">
            <input type = "hidden" name = "_token" value = "<?php echo csrf_token();?>">
